...
class VidhyaSentimentsDataLoader(AbstractDataLoader):
    name = "VidhyaSentimentsDataLoader"

    def __init__(self):
        self.data = DataFrame([])
        self.path = ""

    def export(self, path: str) -> "VidhyaSentimentsDataLoader":
        self.data.to_parquet(path)
        return self

    def load(self) -> "VidhyaSentimentsDataLoader":
